...
def live(nama_saham, waktu_saham):
    ...
    if nama_saham == 'all':
        ...
        return render_template('live.html', saham=nama_saham, periode=waktu_saham, day=date.today().strftime("%A"))
...
def olah_p(periode):
    def data(periode):
        ...
        fHead = "live_trade_"
        fHead2 = "olah/olah_" + str(periode) + '_min_'
        fFoot = ".txt"
